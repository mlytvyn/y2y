package com.github.mlytvyn.y2y.jalo;
...
import com.github.mlytvyn.y2y.constants.Y2YConstants;
import com.github.mlytvyn.y2y.jalo.GeneratedY2YManager;


/**
 * This is the extension manager of the y2y extension.
 */
public class Y2YManager extends GeneratedY2YManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Y2YManager.class);
	 ...
	 */
	public static Y2YManager getInstance()
	{
		return (Y2YManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Y2YConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Y2YManager() // NOPMD
	{
		LOG.debug("constructor of Y2YManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Y2YManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Y2YManager called, current tenant: {}", getTenant().getTenantID());
	}
